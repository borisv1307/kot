from game.newcards.discard_cards.victory_point_manipulation_cards.high_altitude_bombing import HighAltitudeBombing


def test_high_altitude_bombing_takes_3_health(player):
