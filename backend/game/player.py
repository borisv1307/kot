...
class Player:
    ...
    def update_energy_cube_by(self, change_integer):
        self.energy_cube += change_integer
        if self.energy_cube < constants.DEATH_HIT_POINT:
            self.energy_cube = constants.DEATH_HIT_POINT
